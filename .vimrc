...
set smartcase                                               " case insensitive searches unless upper case is used
...
" treat json files as javascript files
...
set wildignore+=*/tmp/*,*.so,*.swp,*.zip,*/templates_c/*,*/bin/* " ,*/vendor/*
